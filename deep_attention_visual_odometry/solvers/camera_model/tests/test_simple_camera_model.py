...
class TestSimpleCameraModel(unittest.TestCase):
    def test_num_parameters_scales_with_num_views_and_num_points(self):
        batch_size = 3
        num_estimates = 7
        num_views = 5
        num_points = 11
        ...
        self.assertEqual(
            3 + 9 * num_views + 3 * num_points, camera_model.num_parameters
        )

    def test_get_error_return_shape(self):
        batch_size = 3
        num_estimates = 7
        num_views = 5
        num_points = 11
        ...
        self.assertEqual((batch_size, num_estimates), error.shape)
    ...
    def test_get_error_returns_square_error_between_estimated_and_true_projected_points(
        ...
        error = camera_model.get_error()
        self.assertEqual((1, 1), error.shape)
        self.assertEqual(
    ...
    def test_get_error_caches_returned_tensor(self):
        batch_size = 3
        num_estimates = 7
        num_views = 5
        num_points = 11
        ...
        self.assertIs(error, error2)

    def make_models_and_mask(
        self,
    ...
    def test_masked_update_produces_same_error_with_no_pre_computation(self):
        (
            camera_model_1,
            camera_model_2,
            update_mask,
            camera_model_3,
        ) = self.make_models_and_mask()
        ...
        self.assertTrue(torch.equal(updated_error, raw_error))

    def test_masked_update_produces_same_error_with_model_1_pre_computed(self):
        (
            camera_model_1,
            camera_model_2,
            update_mask,
    ...
    def test_masked_update_produces_same_error_with_model_2_pre_computed(self):
        (
            camera_model_1,
            camera_model_2,
            update_mask,
    ...
    def test_masked_update_produces_same_error_with_both_models_pre_computed(self):
        (
            camera_model_1,
            camera_model_2,
            update_mask,
    ...
    def test_get_gradient_return_shape(self):
        batch_size = 3
        num_estimates = 7
        num_views = 5
        num_points = 11
        ...
        self.assertEqual(
            (batch_size, num_estimates, camera_model.num_parameters), gradient.shape
        )
